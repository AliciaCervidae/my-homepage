    ...
    <section className="w-full py-12 md:py-16 px-4 bg-background">
      <div className="container max-w-4xl mx-auto">
        <div className="flex flex-col items-center space-y-6">
          {/* 标题 */}
          <h2 className="text-center text-lg md:text-xl font-medium text-foreground font-[Fredoka]">
            Catch me here ! 🦌
          </h2>
          
          {/* 图标链接 */}
          <div className="flex items-center justify-center w-full max-w-2xl">
            <div className="w-full rounded-full bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg p-4 flex items-center justify-around hover:bg-white/20 transition-all duration-300">
              {/* Twitter */}
              <a 
                href="https://x.com/aliciathesika" 
                target="_blank" 
              ...
              {/* GitHub */}
              <a 
                href="https://github.com/AliciaCervidae" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center justify-center w-10 h-10 rounded-full hover:bg-gray-100 transition-colors"
              >
              ...
              {/* Email */}
              <a 
                href="mailto:irisafterrain@outlook.com" 
                className="flex items-center justify-center w-10 h-10 rounded-full hover:bg-gray-100 transition-colors"
              >
